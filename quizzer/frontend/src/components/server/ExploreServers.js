...
function ExploreServers() {
    //To load the categories for the tabs; using states
    ...
    function handleClick(parameter, event){
        //Check for the token 
        const token = localStorage.getItem("token");
        //search for servers through categories
        ...
        //This updates the value of the active category
    ...
    <div className="container pt-5">
        <div className="card">
            <div className="card-content">
                ...
                <p className="subtitle is-3">Find servers</p>

                <form onSubmit={handleSubmit}>
                    <div class="field is-grouped">
                    <p class="control is-expanded">
                        <input class="input" type="text" placeholder="Search for a server" onChange={e => setSearchBody(e.target.value)}/>
                    </p>
                    <p class="control">
